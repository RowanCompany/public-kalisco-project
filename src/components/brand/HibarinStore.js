...
import busanStoreImage from "../../static/images/img-p-store-busan-2.png";
          ...
          <div className="position-relative">
            <div className={styles.storeTextWrapper}>
              <div className="container">
                <div className={styles.storeTextTitle}>스타필드안성점</div>
          ...
          <div className="position-relative">
            <div className={styles.storeTextWrapper}>
              <div className="container text-right">
                <div className={styles.storeTextTitle}>이태원점</div>
                <div className={styles.storeTextDescription}>
