    ...
    },
    {
        ...
        description: (
            <>
                ...
                그 누구보다 방역에 힘쓰고 있습니다.
                <br />
                안심하시고 안전하게 즐기실 수 있도록
                <br />
                매장 내에서 사회적 거리두기 캠페인 또한
                <br />
                열심히 진행하고 있으니,
                <br />
                <br />
                ...
                응원의 메세지를 댓글로 남겨 주시면,
                <br />
                추첨을 통해 사보텐 외식상품권을 드립니다!
                <br />
                (친구 태그 시, 당첨확률 UP! 함께 응원해요!)
                <br />
                <br />
                ▶️ 기간 : 9/3(목) ~ 9/9(수)
                <br />
                ...
                ✔️9월의 딜리버리 추천 메뉴!
                <br />
                ☝🏻양에 놀라고 맛에 놀라는 사보텐 카츠샌드! 중독성 짱!
                #로스카츠샌드
                <br />
                ✌🏻다양한 카츠를 한 번에 즐길 수 있다고? 맥주 안주로도 푸짐한
                #카츠파티팩
            </>
        ),
        type: "saboten",
    },
    {
        ...
        description: (
            <>
                ...
                <br />
                <br />
                #히바린 #돈카츠 #돈까스 #돈카츠맛집 #외식 #신메뉴 #연인 #데이트
                #주말 #데일리 #일식 #정식 #저녁식사 #국내브랜드 #이벤트
                #카츠카페 #플레이트 #카츠 #누들 #샐러드 #이벤트 #플러스친구
                #오픈이벤트 #쿠폰
            </>
        ),
    },
    ...
    },
    {
        ...
        description: (
            <>
                ...
                <br />
                <br />
                어려운 시기, 고생하는 의료진을 히바린도 응원하겠습니다.
                <br />
                <br />
                #히바린 #돈카츠 #돈까스 #돈카츠맛집#사회적거리두기 #코로나
                #코로나예방 #거리두기 #마스크필수#covid19 #social_distancing
                #staysafe
            </>
        ),
    },
    {
        ...
        description: (
            <>
                ...
                #히바린 #돈카츠 #돈까스 #돈카츠맛집 #외식 #신메뉴 #연인 #데이트
                #주말 #데일리 #일식 #정식 #저녁식사 #국내브랜드 #이벤트
                #카츠카페 #플레이트 #카츠 #누들 #샐러드 #냉우동 #여름
                #유린기냉우동 #열대야 #더위 #폭염 #이벤트
            </>
        ),
    },
    {
        ...
        description: (
            <>
                ...
                #히바린 #돈카츠 #돈까스 #돈카츠맛집 #외식 #신메뉴 #연인 #데이트
                #주말 #데일리 #일식 #정식 #저녁식사 #국내브랜드 #이벤트
                #카츠카페 #플레이트 #카츠와아보카도플레이트
                #카츠와쿵파오플레이트 #카츠 #누들 #샐러드 #냉우동 #여름
                #딜리버리 #카츠박스
            </>
        ),
    },
