        ...
        "rice-bowl": {
            ...
            firstDescription: (
                <>
                    ...
                    <br />
                    적게 넣어도 강한 존재감 1:2 배합으로 진한 가쓰오 풍미가
                    입안에서 향유
                    <br />
                    소고기, 돼지고기, 닭고기 재울 때 덮밥소스 활용 볶음요리,
                    생선과 어울리는 감칠맛
                </>
            ),
            secondDescription: (
        ...
        curry: {
            ...
            secondDescription: (
                <>
                    ...
                    천연향신료], 양파페이스트(뉴질랜드산), 사보텐돈카츠소스,
                    생크림, 사과퓨레, 가공버터, 당근, 토마토페이스트,
                    구운소고기추출물, 마늘, 혼합간장, 사과농축액, 대두유,
                    카라멜색소, 땅콩버터, 잔탄검, 코코아분말, 쿡메이트비에프,
                    쿡메이트오에프, 천연향신료, 마늘분말, 생강분말
                </>
            ),
            thirdDescription: (
                <>
