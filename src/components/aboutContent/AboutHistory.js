                    ...
                    <ul style={{ padding: "0", margin: "0" }}>
                        <li>
                            <div className={styles.content}>
                                ...
                                <div className={styles.contentDate}>2001</div>
                        ...
                        <li>
                            <div className={styles.content}>
                                ...
                                <div className={styles.contentDate}>2009</div>
                            </div>
                            <div className={styles.point}></div>
                            <div className={styles.date}>
                        ...
                        <li>
                            <div className={styles.content}>
                                ...
                                <div className={styles.contentDate}>2012</div>
                            </div>
                            <div className={styles.point}></div>
                            <div className={styles.date}>
                        ...
                        <li>
                            <div className={styles.content}>
                                ...
                                <div className={styles.contentDate}>2014</div>
                            </div>
                            <div className={styles.point}></div>
                            <div className={styles.date}>
                        ...
                        <li>
                            <div className={styles.content}>
                                ...
                                <div className={styles.contentDate}>2016</div>
                                <div className={styles.contentParagraph}>
                                    히바린 1호점 신세계강남점 오픈
                                </div>
                            </div>
                        ...
                        <li>
                            <div className={styles.content}>
                                ...
                                <div className={styles.contentDate}>2018</div>
                            </div>
                            <div className={styles.point}></div>
                            <div className={styles.date}>
                        ...
                        <li>
                            <div className={styles.content}>
                                <div style={{ paddingBottom: "30px" }}>
                                    <img src={history10} alt="10th history" />
                                </div>
                                <div className={styles.contentTitle}>
                                    사보텐 정통 컨셉스토어
                                </div>
                        ...
                        <li>
                            <div className={styles.content}>
                                <div style={{ paddingBottom: "30px" }}>
                                    <img src={history11} alt="11th history" />
                                </div>
                                <div className={styles.contentTitle}>
                                    HMR 제품 온라인 유통 판매 강화
                                </div>
                                <div className={styles.contentDate}>2019</div>
                            </div>
                            <div className={styles.point}></div>
                            <div className={styles.date}>
                        ...
                        <li>
                            <div className={styles.content}>
                                <div style={{ paddingBottom: "30px" }}>
                                    <img src={history12} alt="12th history" />
                                </div>
                                <div className={styles.contentTitle}>
                                    “사보텐” 브랜드 20주년
                                </div>
                                <div className={styles.contentDate}>2020</div>
                            </div>
                            <div className={styles.point}></div>
                            <div className={styles.date}>
                        ...
                        <li>
                            <div className={styles.content}>
                                <div style={{ paddingBottom: "30px" }}>
                                    <img src={history13} alt="13th history" />
                                </div>
                                <div className={styles.contentTitle}>
                                    맛을 아는 사람들 캘리스코가 만든
                                    <br />
                        ...
                        <li>
                            <div className={styles.content}>
                                <div style={{ paddingBottom: "30px" }}>
                                    <img src={history14} alt="14th history" />
                                </div>
                                <div className={styles.contentTitle}>
