...
export default function ProductSauceDetail({ content }) {
  ...
  const sauceData = {
    ...
    sesame: {
      ...
      firstDescription: (
        <>
          ...
          <br />
          엄선된 재료로 위생적이고 엄격한 품질 관리하에 만든 Chef made 제품
          <br />
    ...
    citron: {
      ...
      firstDescription: (
        <>
          비타민C가 풍부해서, 노화와 피로 회복에
          <br />
          효과가 있는 국내산 전라도 황유자 사용
          <br />
          <br />
  ...
  switch (sauce) {
    ...
    case "rice-bowl":
      return (
        <>
          <section className={styles.productSauceDetailSection}>
            <ProductDetailNavigator content={content} />
            <SauceNavigator sauce={sauce} />
            <div className={styles.sauceDetailImageWrapper}>
              <img
            ...
            <div className={styles.sauceDetailFirstDescriptionsWrapper}>
              <div className={styles.sauceDetailFirstTitle}>
                {sauceData[sauce] && sauceData[sauce]["firstTitle"]}
              </div>
              <div className={styles.sauceDetailPrice}>
            ...
            <div className={styles.sauceDetailFirstDescriptionsWrapper}>
              <div className={styles.sauceDetailTextSubTitle}>
                어울리는 음식
              </div>
              <div className={styles.sauceDetailTextDescription}>
