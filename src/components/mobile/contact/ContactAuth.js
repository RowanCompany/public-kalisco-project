          ...
          <section className={styles.contactAuthSection}>
            <div className={styles.contectAuthWrapper}>
              ...
              <div className={styles.contactAuthSub}>
                문의사항에 대한 답변은 입력하신 이메일 주소로 보내드립니다. 항상 고객의 목소리에 귀 기울이는 캘리스코가 되겠습니다.
              </div>
              <div className={styles.contactAuthDesc}>회원 로그인 또는 비회원 실명인증 하시면 문의 등록이 가능합니다.</div>
              <div className={styles.contactAuthDesc}>본인인증 시 제공되는 정보는 해당 인증기관에서 직접 수집하며, 인증 이외의 용도로 이용 또는 저장되지 않습니다.</div>
              <div className={styles.contactAuthConfirmTitle}>
                <div className={styles.contactAuthConfirmTitleText}>비회원 실명 인증</div>
              </div>
              <div className={styles.contactAuthConfirmDesc}>
                아이핀 인증이나 휴대전화 인증 중<br />하나를 선택하여<br />본인확인을 진행해 주세요.
              </div>
              <button 
                type="button"
